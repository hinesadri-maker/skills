...
- 1. **The final version.** Placed first, with no preamble above it.
  2. 2. **A change log.** One line per round, stating what died that round. For example:
     3.    - Round 1: cut 3 empty openers, added the real date and owner.
     ...
     4.**Task:** team email. Launch delayed Sept 15 → Oct 6, because the payment integration failed compliance.
